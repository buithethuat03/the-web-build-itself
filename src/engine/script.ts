...
export const RAW_CUES: Cue[] = [
  ...
  { id: 'c2-t2', start: 111.0, duration: 8.0, type: 'type', buffer: 'html', code: `    <a href="#experience">Experience</a>\n    <a href="#architecture">Architecture</a>\n    <a href="#projects">Projects</a>\n    <a href="#contact">Contact</a>\n  </nav>\n` },
  ...
  { id: 'c3-t1', start: 152.0, duration: 5.0, type: 'type', buffer: 'html', code: `  <main id="about">\n    <section id="education">\n      <h2>Education &amp; Academic Honors</h2>\n` },
  ...
  // ==========================================
  // CHAPTER 7: PRINCIPLES & QUICK CONNECT (06:20 - 07:00)
  // Clean Architecture philosophy & native HTML dialog.
  // ==========================================
  { id: 'c7-init', start: 380.0, duration: 1.0, type: 'chapter', chapterIndex: 7, year: "Philosophy", title: "Principles & Quick Connect", theme: "Clean Architecture, system resilience, and native contact modal dialog." },
  { id: 'c7-layout', start: 380.0, duration: 1.0, type: 'layout', mode: 'split' },

  { id: 'c7-t1', start: 382.0, duration: 9.0, type: 'type', buffer: 'html', code: `    <section id="philosophy">\n      <h2>Engineering Principles</h2>\n      <details open>\n        <summary>Clean Architecture &amp; System Resilience</summary>\n` },
  { id: 'c7-t2', start: 392.0, duration: 10.0, type: 'type', buffer: 'html', code: `        <p>Software excellence lies in high cohesion, loose coupling, and proactive observability. By decoupling business logic from frameworks and isolating distributed events with Dapr &amp; Kafka, systems scale gracefully across cloud clusters.</p>\n      </details>\n` },
  { id: 'c7-t3', start: 403.0, duration: 12.0, type: 'type', buffer: 'html', code: `      <div class="contact-cta">\n        <button type="button" id="btn-open-contact" class="btn-primary">Connect with Bui The Thuat</button>\n        <dialog id="contact-dialog">\n          <h3>Get in Touch · Bui The Thuat</h3>\n          <p class="dialog-subtitle">Backend Developer &amp; DevOps Engineer · Hanoi, Vietnam</p>\n          <div class="dialog-info">\n            <p>📱 <strong>Phone:</strong> (+84) 339350174</p>\n            <p>✉ <strong>Email:</strong> thuatdk@gmail.com</p>\n            <p>💻 <strong>GitHub:</strong> <a href="https://github.com/buithethuat03" target="_blank">github.com/buithethuat03</a></p>\n            <p>🎓 <strong>UET-VNU:</strong> B.S. in IT (GPA 3.72 / 4.0)</p>\n          </div>\n          <button type="button" id="btn-close-contact">Close</button>\n        </dialog>\n      </div>\n    </section>\n` },
  { id: 'c7-pause', start: 416.0, duration: 4.0, type: 'pause' },

  // ==========================================
  // CHAPTER 8: FEATURED PROJECTS (07:00 - 07:40)
  // AI/NLP Thesis (PhoBERT 99.44%), Securities Cashflow, Omnichannel Chat.
  // ==========================================
  { id: 'c8-init', start: 420.0, duration: 1.0, type: 'chapter', chapterIndex: 8, year: "Projects", title: "Featured Engineering Projects", theme: "PhoBERT ML Thesis (99.44% Acc), Securities Cashflow, Omnichannel Chat." },
  { id: 'c8-layout', start: 420.0, duration: 1.0, type: 'layout', mode: 'split' },

  { id: 'c8-t1', start: 422.0, duration: 8.0, type: 'type', buffer: 'html', code: `    <section id="projects">\n      <h2>Featured Projects</h2>\n      <div class="project-card">\n        <div class="proj-head">\n          <h3>Automatic Classification of Multiple-Choice Questions</h3>\n          <span class="badge">ML Thesis · 2025</span>\n        </div>\n        <p>Fine-tuned PhoBERT into specialized models (SGDModel &amp; ChapterModel) using a semi-supervised training loop on ~19k labeled and ~32k unlabeled questions. Applied focal loss and early stopping.</p>\n` },
  { id: 'c8-t2', start: 431.0, duration: 12.0, type: 'type', buffer: 'html', code: `        <div class="metric-row">\n          <div class="metric-box"><span>Subject Acc</span><strong>99.44%</strong></div>\n          <div class="metric-box"><span>Grade Acc</span><strong>95.96%</strong></div>\n          <div class="metric-box"><span>Chapter Acc</span><strong>94.09%</strong></div>\n          <div class="metric-box"><span>Difficulty Acc</span><strong>77.20%</strong></div>\n        </div>\n      </div>\n` },
  { id: 'c8-t3', start: 444.0, duration: 12.0, type: 'type', buffer: 'html', code: `      <div class="project-card">\n        <div class="proj-head">\n          <h3>Cash Flow Management System for Securities Companies</h3>\n          <span class="badge">Backend &amp; DevOps</span>\n        </div>\n        <p>Securities cash-in/out and reconciliation microservices built with Spring Boot, Kafka, MySQL, Docker, K8s, Prometheus, and Grafana.</p>\n        <p class="proj-link">🔗 <a href="https://github.com/buithethuat03/cashflow-management-system" target="_blank">github.com/buithethuat03/cashflow-management-system</a></p>\n      </div>\n    </section>\n` },
  { id: 'c8-pause', start: 457.0, duration: 3.0, type: 'pause' },
